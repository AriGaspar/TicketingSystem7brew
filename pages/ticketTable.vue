...
<!-- FILTERS -->
        <div class="flex flex-row justify-center gap-4 py-4 items-center w-full">
            FILTER BY: 
            <div class="w-40">
                <DropboxComp id="requester" :default_caption="'REQUESTER'" :text_type="'milkstore04-text text-sm'" :options="requester_options" @input="requester" />
                <span class="flex milkstore04-text text-xxs justify-center">
                    <!-- Requester -->
                </span>
            </div>
            <div class="w-40">
                <DropboxComp id="priority" :default_caption="'PRIORITY'" :text_type="'milkstore04-text text-sm'" :options="priorities_options" @input="priority" />
                <span class="flex milkstore04-text text-xxs justify-center">
                    <!-- Priority -->
                </span>
            </div>
            <div class="w-40">
                <DatePicker id="priority" @dateValue="this.date" />
                <span class="flex milkstore04-text text-xxs justify-center">
                    <!-- Date -->
                </span>
            </div>
...
<script>
    ...
    methods: {
        ...
        SearchByFilter(){
            ...
            if (this.date) keys.push('date');

            const fuse = new Fuse(this.tickets_from_db, {keys});
            this.table_tickets = fuse.search('').map(({ item }) => item);
            console.log(this.table_tickets);
